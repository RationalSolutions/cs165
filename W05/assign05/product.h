...
//TODO: Add the following to your Product class:
//    getName / setName
...
//    Default Constructor- Set the name to "none", description to "", and the
//                         weight and the base price to 0.
//    Non-default - Accepts all four of these values (name, description,
//                  basePrice, weight) and sets them.