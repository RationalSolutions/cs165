...
void Game :: draw(const Interface & ui)
{
   ...
   {
      Point gameOverTextLocation;
      gameOverTextLocation.setX(topLeft.getX() + 100);
      gameOverTextLocation.setY(topLeft.getX() - 100);
